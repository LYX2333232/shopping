  ...
  <view class="all">
    <view class="flash">
      <view class="tn-flex-center-start">
        ...
        <view v-show="size.or_price" class="old"> ￥{{ size.or_price }} </view>
      </view>
      <view class="right">
        <view class="tn-flex-center-start">
          <view> 距结束 </view>
...
.flash {
  ...
  height: 162rpx;
  margin-bottom: -40rpx;
  background: url("http://mmbiz.qpic.cn/mmbiz_png/4UKU63bxibhQ9xr6k6haSXtWWE8Sa8PIkWm7dWr5Qvu2vBz1tvqN077GSia1LoK2ibI7rNrUIJRauV5tibbjtzJmeQ/0?wx_fmt=png")
